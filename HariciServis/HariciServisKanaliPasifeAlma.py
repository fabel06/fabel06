...
time.sleep(2)
driver.find_element(By.XPATH, "//body/app-dashboard[@class='ng-star-inserted']//app-networkmanagement[@class='ng-star-inserted']/div[2]/p-table[@class='networkSettingDT']//table[@role='grid']/tbody/tr[1]/td[6]/button[2]").click()
time.sleep(1)
