...
driver.find_element(By.XPATH, "//body/app-dashboard[@class='ng-star-inserted']/div[@class='app-body']/div[@class='sidebar']/nav[@class='sidebar-nav']/ul[@class='nav']/li[14]/a[1]").click()
time.sleep(1)
#CİT yönetimi alt menüsüne tıkla
driver.find_element(By.XPATH, "//app-dashboard[@class='ng-star-inserted']//nav[@class='sidebar-nav']/ul[@class='nav']/li[14]/ul[@class='nav-dropdown-items']/li[3]/a[@href='#/systemManagement/citManagement']").click()
time.sleep(1)
