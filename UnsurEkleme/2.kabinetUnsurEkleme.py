...
driver.get("http://10.1.112.104/#/pages/login")
driver.maximize_window()
# --find locators
driver.find_element(By.NAME, "username").send_keys("@dettaadmin")
driver.find_element(By.NAME, "password").send_keys("admkkkin")

# //tagname[@attribute='value']  //input[@type='submit']
driver.find_element(By.XPATH, "(//button[contains(text(),'Oturum Açınız')])[1]").click()
time.sleep(2)
driver.find_element(By.XPATH,
                    "//app-dashboard[@class='ng-star-inserted']//nav[@class='sidebar-nav']/ul[@class='nav']/li[14]/a[@id='dropdownMenu']").click()
time.sleep(1)
...
# 6.Yeni Unsur Ekleme
driver.find_element(By.XPATH, "//span[normalize-space()='Yeni Unsur Ekle']").click()
driver.find_element(By.XPATH, "//input[@name='name']").send_keys("golcuk")
driver.find_element(By.XPATH, "//input[@name='ipAddress']").send_keys("17229.1.1")
driver.find_element(By.XPATH, "//input[@name='latitude']").send_keys("39.53")
driver.find_element(By.XPATH, "//input[@name='longitude']").send_keys("32.23")
time.sleep(1)
driver.find_element(By.CSS_SELECTOR,"div[role='dialog'] p-footer > .p-button.p-button-success.p-component > .p-button-label").click()
time.sleep(3)
driver.close()
